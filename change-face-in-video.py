...
if __name__ == "__main__":
    ...
    #                     help='the full path to jpg file with face', default='./mask-2.png')
    ...
    #                     process video will be shown on the screen, but not saved.', default='./out.mov')
    ...
    #     except:
    #         print '*** Something went wrong. Error: {} ***'.format(sys.exc_info())
    warp_face_from_webcam('demo/abl.jpg', 'demo/out.mov')
